...
{
    public class OldMessageLog : MessageLogBase, IMessageAuditLog, IEventLogReader
    {
        private string connectionString;

        public OldMessageLog(string connectionString, ITextSerializer serializer, IMetadataProvider metadataProvider, ITracer tracer, ISystemTime dateTime)
